          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-4 rounded-lg border p-6">
                ...
                <p className="text-center text-muted-foreground">
                  Connect directly with buyers and earn more for your hard work, with no middlemen
                  taking a large cut.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-4 rounded-lg border p-6">
                ...
                <p className="text-center text-muted-foreground">
                  Reach local and international buyers looking for quality, traceable products like
                  yours.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-4 rounded-lg border p-6">
                ...
                <p className="text-center text-muted-foreground">
                  Get connected to training, financing, and tools that help you meet local and
                  global standards.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2">
              <div className="flex flex-col items-center space-y-4 rounded-lg border p-6">
                ...
                <p className="text-center text-muted-foreground">
                  Build with farmers in mind, we offer security, transparency, and commitment to
                  your success.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-4 rounded-lg border p-6">
                ...
                <p className="text-center text-muted-foreground">
                  Start for free with flexible options designed to fit your needs and scale as you
                  grow.
                </p>
              </div>
            </div>
      ...
      <footer className="border-t py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          ...
          <div className="flex gap-4">
            <Link
              href={BUYER_PLATFORM_URL_CONTACT}
